...
HD_PWD='C:/Users/jsepc/Desktop/Apuntes Y Cosas Uni/SED/Trabajo SED/Trabajo SED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_entity_global.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_entity_global.tcl
