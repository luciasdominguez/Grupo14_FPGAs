...
HD_PWD='C:/Users/jsepc/Desktop/Apuntes Y Cosas Uni/SED/Trabajo SED/Trabajo SED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_entity_global.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_entity_global.tcl -notrace
